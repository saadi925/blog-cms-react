...
export function FontSizeComponent({ editor }: { editor: Editor }) {
  ...
  return (
    <div className={"font-size-container"}>
        ...
        <input className="bg-gray-600 rounded-lg text-white px-2"
        ...
        />
      <select className="bg-gray-600 text-white px-2 py-1 rounded-lg"
        value={fontSize}
        onChange={(e) => handleFontSizeSelect(e.target.value)}
      >
        <option defaultValue={fontSize}>{fontSize}</option>
