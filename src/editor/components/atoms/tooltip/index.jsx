...
import Style from "./tooltip.style.jsx";
...
const Tooltip = (props) => {
  ...
  useEffect(() => {
    if (propsAnchorRef.current?.getBoundingClientRect) {
      ...
      anchorRef.current =
        document.querySelector(propsAnchorRef.current) ??
  ...
  useEffect(() => {
    if (anchorBox.width) {
      ...
      if (/^top$|^bottom$/.test(props.orientation)) {
        const leftOffset =
          containerBox.left -
          (anchorBox.left + anchorBox.width / 2 - refBox.width / 2);
        const rightOffset =
          containerBox.right -
          (anchorBox.right - anchorBox.width / 2 + refBox.width / 2);
        ...
        const topOffset =
          containerBox.top -
          (anchorBox.top + anchorBox.height / 2 - refBox.height / 2);
        const bottomOffset =
          containerBox.bottom -
          (anchorBox.bottom - anchorBox.height / 2 + refBox.height / 2);
    ...
    <Style
      ...
      css={[
        ...
        props.orientation === "top" && {
          ...
          left: `${
            anchorBox.left + anchorBox.width / 2 + overflow - tipPos.width / 2
          }px`,
        },
        ...
        props.orientation === "left" && {
          top: `${
            anchorBox.top + anchorBox.height / 2 + overflow - tipPos.height / 2
          }px`,
